...
import {AutoGenerateAttributeRawMetadataOptions} from '@typedorm/common/metadata-storage';
...
export interface AutoGeneratedAttributeMetadataOptions
  extends AutoGenerateAttributeRawMetadataOptions {
  connection: Connection;
}

export class AutoGeneratedAttributeMetadata extends BaseMetadata {
  readonly value: any;
